...
public class EnvironmentTypeView : UICompanent, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler {
    public event Action<EnvironmentTypeView> EnvironmentTypeViewSelected;
    ...
    public void Init(EnvironmentConfig config) {
        Config = config;
    ...
    private void Select() {
        ...
        EnvironmentTypeViewSelected?.Invoke(this);
    }
